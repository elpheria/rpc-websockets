...
import { IJsonRpcSocket, TRpcNotificationHandler, TRpcNotificationName, TRpcNotificationParams, TRpcRequestHandler, TRpcRequestName } from "../JsonRpcSocket/types";
interface INamespace extends EventEmitter {
    ...
    onNotification(name: TRpcNotificationName | {
        [key: string]: TRpcNotificationHandler;
    }, handler?: TRpcNotificationHandler): void;
    onceNotification(name: TRpcNotificationName | {
        [key: string]: TRpcNotificationHandler;
    }, handler?: TRpcNotificationHandler): void;
    offNotification(name: TRpcNotificationName | {
        [key: string]: TRpcNotificationHandler;
    }, handler?: TRpcNotificationHandler): void;
    sendNotification(name: TRpcNotificationName, params?: TRpcNotificationParams): Promise<unknown>;
    ...
    onInternalNotification(name: TRpcNotificationName | {
        [key: string]: TRpcNotificationHandler;
    }, handler?: TRpcNotificationHandler): void;
    onceInternalNotification(name: TRpcNotificationName | {
        [key: string]: TRpcNotificationHandler;
    }, handler?: TRpcNotificationHandler): void;
    offInternalNotification(name: TRpcNotificationName | {
        [key: string]: TRpcNotificationHandler;
    }, handler?: TRpcNotificationHandler): void;
    sendInternalNotification(name: TRpcNotificationName, params?: TRpcNotificationParams): Promise<unknown>;
...
declare type TNamespaceName = string;
...
export { INamespace, TNamespaceName, INamespaceOptions, INotificationsSubscriptionsResult };
